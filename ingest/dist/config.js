...
exports.CONFIG = {
    ...
    GEO_DB: process.env.GEO_DB || './geo/GeoLite2-City.mmdb',
    ...
    // File store path for installs counters - use relative path that's writable
    STORE_FILE: process.env.STATS_JSON_FILE || path_1.default.join(process.env.LOG_DIR || './data', 'installs.json')
};
